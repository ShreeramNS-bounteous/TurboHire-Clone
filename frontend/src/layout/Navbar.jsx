    ...
    <div className="bg-[#101828] h-12">
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="w-10 h-10 bg-black rounded-md flex items-center justify-center relative overflow-hidden shadow-md shadow-gray-700  group-hover:shadow-md transition-all">
